...
class Unassigned_user_recycler_Adapater(val profile_image : List<Int> , val patient_name : List<String> , val time : List<String>): RecyclerView.Adapter<Unassigned_user_viewholder>() {
...
class Unassigned_user_viewholder(itemView: View): RecyclerView.ViewHolder(itemView){
