...
class AssignTherapist_Recycler_Adapter(val profile_image : List<Int> , val patient_name : List<String> , val time : List<String>): RecyclerView.Adapter<AssignTherapist_Recycler_viewholder>() {
