...
import com.example.pukaaradmin.databinding.FragmentAllSessionsBinding


class All_Sessions : Fragment() {

    private lateinit var allSessionsBinding: FragmentAllSessionsBinding
    ...
    override fun onCreateView(
        ...
        allSessionsBinding = FragmentAllSessionsBinding.inflate(inflater , container , false)
        // Inflate the layout for this fragment
        val recyclerView = allSessionsBinding.allSessionsRecycler
        recyclerView.adapter = All_Session_Recycler_Adapter(patient_name , date , time , session_taken)
        recyclerView.layoutManager = LinearLayoutManager(context , LinearLayoutManager.VERTICAL , false)



        return allSessionsBinding.root
    }
